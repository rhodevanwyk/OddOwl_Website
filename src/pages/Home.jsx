          ...
          <div className="mx-auto grid max-w-7xl gap-14 px-5 md:px-8 lg:grid-cols-12">
            <div className="reveal lg:col-span-5">
              ...
              <p className="mt-5 max-w-md text-lg leading-relaxed text-mist">
                If you are in search of something new, unique, something of your taste. Please fill the form so that we can discuss you perfect custom piece. Otherwise please contact us via the email below for an questions you might have.
              </p>
